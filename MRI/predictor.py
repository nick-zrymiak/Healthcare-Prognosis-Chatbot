'''
Disease predictor program to predict from brain MRI scan whether a user has cancer or not.

The code is ready to run with all data included.

Just pass "python predictor.py" or "python3 predictor.py"
'''
